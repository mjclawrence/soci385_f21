...
```
Sex difference in orientation distribution

```{r}
round(prop.table(table(cupid$sex, cupid$orientation),1),3)
```

Average age of male and female respondents in each orientation category.
