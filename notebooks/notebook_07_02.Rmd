...
First let's create a binary variable called `has_ideal` identifying respondents whose number of children is equal to their ideal number of children with a 1 and everyone else with a 0.
