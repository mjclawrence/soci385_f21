...
What would you expect about the relationship between income and life expectancy in countries? Try a plot first (with `gross_national_income` as the x and `life_expectancy` as the y. 
...
### REPLACE THIS LINE WITH YOUR CODE ###
```{r}
hdi$log_gross_national_income[hdi$country=="United States"]
19.5244 + (5.6811*10.88266)
```
