...
### Remember the `fitted()` function can calculate predictions and save them as a new variable:
...
### You can pander the saved object for a nice table:

```{r, eval = FALSE}
pander(lookrel_predictions)
```
