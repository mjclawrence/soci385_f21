...
- Already have their dependent or outcome variable
...
- Sounds like an independent or predictor variable
...
- Hurricane names, number of deaths

--

- Scores for each name on masculine-feminine scale
