...
gss_week11 <- read.csv("https://raw.githubusercontent.com/mjclawrence/soci385_f21/main/data/gss_week_11.csv")
library(tidyverse)
library(pander)
library(kableExtra)
```

## [Fertility Visualiztion](https://twitter.com/toddrjones/status/1195476826728128514)
...
gss_week11$degree <- relevel(gss_week11$degree, 
  ref = "College Degree")
...
```{r, eval = FALSE}
gss_week11$religion <- 
relevel(gss_week11$religion, ref = "Protestant")
