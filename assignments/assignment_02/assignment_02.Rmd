...
assignment2 <- read.csv("https://raw.githubusercontent.com/mjclawrence/soci385/master/data/assignment_02.csv")
library(tidyverse)
```
...
There are 3605 observations in this data frame
...
In the subset of college degree holders, the mean is 27.39 and the median is 27.
