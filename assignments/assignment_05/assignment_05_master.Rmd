...
assignment_05 <- read.csv("../../data/assignment_05.csv")
library(tidyverse)
```
...
assignment_05 <- assignment_05 |> 
  mutate(college_degree = ifelse(str_detect(degree, "degree"), 1, 0),
         any_days = ifelse(mntlhlth>0, 1, 0))
```
...
```{r}
t.test(assignment_05$mntlhlth[assignment_05$college_degree==0],
          assignment_05$mntlhlth[assignment_05$college_degree==1])
```
